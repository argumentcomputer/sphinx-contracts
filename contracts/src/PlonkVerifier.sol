...
contract PlonkVerifier {
  ...
  uint256 private constant VK_QL_COM_X = 20181627300711023868093869036494448750331669968710441417386509978815631555020;
  uint256 private constant VK_QL_COM_Y = 8119873579662458667096439454771444702414661187063824826404799478295593414197;
  uint256 private constant VK_QR_COM_X = 11957086080070403153318333083412068592538124988711772417045537271678349084746;
  uint256 private constant VK_QR_COM_Y = 2509626877457680780249530763913907310530170376890188221207577901144932853547;
  uint256 private constant VK_QM_COM_X = 13819088740190279142739931348942919143688654628860202280216789407302757777326;
  uint256 private constant VK_QM_COM_Y = 14913749131282909176651868745032229528555611964229236061290890615709215131765;
  uint256 private constant VK_QO_COM_X = 2075948425301303993802261285211089913018654118890402974953750142187573800706;
  uint256 private constant VK_QO_COM_Y = 9535321887161845907337184356393009643454612148913942520052065315297904832934;
  uint256 private constant VK_QK_COM_X = 16527731424647856664323996595755191187137753671985405813245980484964562445204;
  uint256 private constant VK_QK_COM_Y = 18698869899084999102157675724749960238859036040473540000506504386519074748423;
  
  uint256 private constant VK_S1_COM_X = 5786821900416973211223897891835691036776598709553076964817205018925493752849;
  uint256 private constant VK_S1_COM_Y = 2950226396939438348607033494122968609919075515403528170356290199685105542586;
  
  uint256 private constant VK_S2_COM_X = 1430923547242520811584382342009189446409481629702542684559369650245662336583;
  uint256 private constant VK_S2_COM_Y = 11194109881379566359993291058925512871320568748925331686010734844066186899296;
  
  uint256 private constant VK_S3_COM_X = 11749765245000956210159083037343095278286313766278814338972522682969863688143;
  uint256 private constant VK_S3_COM_Y = 1942707167234362285487679155101664263413767744524890010028003738909160801443;
  
  uint256 private constant VK_COSET_SHIFT = 5;
  
  
  uint256 private constant VK_QCP_0_X = 18505326969220888712458776415406947909308595537518902677516311884559765335041;
  uint256 private constant VK_QCP_0_Y = 2693223847217865683678665050044942426815675482286424043944271144107220677300;
  
  
  uint256 private constant VK_INDEX_COMMIT_API_0 = 32448822;
