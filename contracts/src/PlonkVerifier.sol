...
contract PlonkVerifier {
  ...
  uint256 private constant VK_QL_COM_X = 48928834306167443025507055502202067200240823993352402100102620828723773653;
  uint256 private constant VK_QL_COM_Y = 2042095935721586861269278494849843501067752929878965775735116249791377189349;
  uint256 private constant VK_QR_COM_X = 9263055746511352788967168242441740132968013915506788573208357567094202827437;
  uint256 private constant VK_QR_COM_Y = 17628428921127964441677913917368279104903634377401680292327523375466045449821;
  uint256 private constant VK_QM_COM_X = 5386497313205418866075671870604723600462702364443576348523388000562720155397;
  uint256 private constant VK_QM_COM_Y = 10251277836844837493691486022258656237409980141605838548173765900573579037048;
  uint256 private constant VK_QO_COM_X = 17892144205963166011887822724506030774548821972604674531477350577120233687735;
  uint256 private constant VK_QO_COM_Y = 12628315211947344797164579921778371930128823896428193831555008525111790366444;
  uint256 private constant VK_QK_COM_X = 14861769437953976497529730847443333640366704373271067429561158303180456942870;
  uint256 private constant VK_QK_COM_Y = 14662562919486173853933305484282245429424763948861532235926442375885400771007;
  
  uint256 private constant VK_S1_COM_X = 3073888053341554920881016181058807402426536838286493276385115449633539775248;
  uint256 private constant VK_S1_COM_Y = 5384424222329100501817783245522106750938337029519044356500555260900853476873;
  
  uint256 private constant VK_S2_COM_X = 19461186879863774198290657382293078306984201116484502913827155116237255045292;
  uint256 private constant VK_S2_COM_Y = 2873204720580225076071638780752364114819201030390154715441418039817738911367;
  
  uint256 private constant VK_S3_COM_X = 2096906860978765391282094222602615310661660657556910851436043580799708727565;
  uint256 private constant VK_S3_COM_Y = 2161063310508571838500646252285726166473952589055632093444464980556430797130;
  
  uint256 private constant VK_COSET_SHIFT = 5;
  
  
  uint256 private constant VK_QCP_0_X = 7517051128132060126170113520963297922398874457515198318132621766317406868261;
  uint256 private constant VK_QCP_0_Y = 11472137363060303021114982968577795162044850614296769357227193724808785551909;
  
  
  uint256 private constant VK_INDEX_COMMIT_API_0 = 31314682;
